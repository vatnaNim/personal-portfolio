        ...
        <div 
            ...
            <div 
                ...
                <div 
                    ...
                    <h2 
                        className={`text-lg-clamp sm:text-lg-clamp font-semibold pb-10 hidden sm:block ${isDarkMode? 'text-gray-300' : ' text-gray-800'}`}>
                    ...
                    <div 
                        ...
                        <span
                            className={`font-base-clamp  font-medium ${isDarkMode? 'text-gray-300' : ' text-gray-900'}`}>
                            @Vatna
                        </span>
                    </div>
                    <div 
                        ...
                        <span
                            ...
                            <p className={`text-md-clamp text-nowrap ${isDarkMode? 'text-gray-300' : ' text-gray-900'}`}>
                                {phoneNumber}
                            </p>
                            <Tooltip 
                                arrow
