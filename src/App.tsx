...
function App() {
    ...
    */
    ...
    Start:Declare Hook
    */
    const defaultColor = colorTheme.find(c => c.isDefault);
    ...
    */
    ...
    return (
        <HelmetProvider>
            <ErrorBoundary>
                <div 
                    className={`bg-white dark:bg-black text-black dark:text-white relative min-h-screen w-full`}>
                    <div 
                    ...
                    <div 
                        ...
                        <div 
                            className={`w-full z-20 sticky top-0 ${isDark ? 'backdrop-blur-md bg-black/30' : 'backdrop-blur-md bg-white/30'}`}>
                            <NavigationBar
                                isDarkMode={isDark}
