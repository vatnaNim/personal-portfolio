...
const Contect = ({ isDarkMode ,activeBg, activeColor, activeHover, activeBorder, activeGradient}: iContectProps) => {
    /* 
    Start:Delare hook
    */
            ...
            <div 
                ...
                <div 
                    ...
                    <div 
                        ...
                        style={{ animationDuration: '1s' }}>
                        <p
                            className={`text-sm-clamp sm:text-md-clamp dark:text-gray-400 text-gray-700`}>
                    ...
                    <div 
                        className={`
                            flex-1 w-full p-3 sm:p-4 rounded-xl shadow-lg   items-center justify-center animate__lightSpeedInRight
                            border border-gray-300 dark:border-gray-600
                            bg-gray-300/20 dark:bg-gray-400/20 backdrop-blur-sm
