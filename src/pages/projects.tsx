    ...
    const projectDb = [
        {
            ...
            status: "success",
            gitHub_link: "https://github.com/vatnaNim/vatna-portfolio",
            lang: ["react.ts", "tailwind", "material UI", "java script", "type script"],
            url: "https://vatnaportfolio.vercel.app/",
        },
        {
            id: 2,
            image: CoffeeShop,
        ...
        },
        {
            ...
            url: "https://starbuck-mu.vercel.app",
        },
        {
            id: 5,
            image: SkinCare,
        ...
        },
        {
            ...
            lang: ["vue", "nuxt.js", "tailwind", "java script", "type script"],
            url: "https://personal-photographer-project.vercel.app",
        },
        {
            id: 8,
            image: "",
        ...
        <div
            ...
            <div
                ...
                style={{ animationDuration: "1s" }}>
                {
                    ...
                    <div
                        key={project.id}
                        className={`backdrop-blur-sm bg-gray-300/20 dark:bg-gray-700/20 border ${activeBorder}  rounded-md p-4 shadow-lg  flex flex-col gap-2`}>
                        <div 
                            className="overflow-hidden rounded-md border border-gray-400">
                            <img
                        ...
                        <div 
                            className="mt-2">
                            <h2 
                                className={`text-xl font-semibold capitalize ${activeColor}`}>
                                {project.projectName}
                            </h2>
                            <p 
                                className={`text-sm mt-1 text-ellipsis overflow-hidden text-gray-700 dark:text-gray-300`}>
                                {
                                    isExpanded
                                    ? project.discretion
                        ...
                        <div 
                            className="flex gap-1 flex-wrap mt-2">
                            {
                                ...
                                <span
                                    key={idx}
                                    className={`text-xs font-semibold border rounded-md px-1.5 py-0.5 ${activeColor} border-current uppercase`} >
                                    {language}
                                </span>
                            ))}
                        </div>
